...
// But:
//
// Needs to be exapnded to improve the capability to identify more browsers, 
// operating systems etc.  Where a user agent string cannot be identified it
// should be emailed to the site admin for further investigation
//
// SourceForge: Breaking Down the Barriers to Open Source Development
// Copyright 1999-2000 (c) The SourceForge Crew
// http://sourceforge.net
//
// $Id: lib_browser_old.php,v 1.1 2001/12/04 17:08:39 mtbwales Exp $
